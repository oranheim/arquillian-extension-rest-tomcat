...
import org.example.app.CustomerResource;
...
public class SimpleRestClientTestCase {
    ...
    @Path("/customer")
    public void getAllCustomersWithCustomInterface(@ArquillianResteasyResource CustomerResource customerResource)
    {
//        Given

//        When
        Customer result = customerResource.getByName("foo");
...
//
////        When
//        final Customer result = customerResource.getById(customerId);
//
////        Then
//        assertNotNull(result);
